...
const SignUp = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-w-96 mx-auto media-signup">
            ...
            <form onSubmit={handleSubmit}> 
                <div>
                    <label className="label p-2">
                        <span className="text-base label-text text-white opacity-85">Full Name</span>
                    </label>
                ...
                <div>
                <label className="label p-2">
                        <span className="text-base label-text text-white opacity-85">Confirm Password</span>
                    </label>
                ...
                <Link to={"/login"} className="text-sm hover:underline hover:text-blue-600 text-white opacity-75 mt-2 inline-block">Already have an account?</Link>
